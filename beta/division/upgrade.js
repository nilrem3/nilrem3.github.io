...
new upgrade("Synergy 1", new Decimal(10000), "Divider 1 effect +0.01 per Divider 2 purchased", unlocked=true);
new upgrade("Synergy 2", new Decimal(50000), "Divider 2 effect +0.02 per Divider 3 purchased", unlocked=false);
new upgrade("Synergy 3", new Decimal(250000), "Divider 3 effect +0.03 per Divider 4 purchased", unlocked=false);
new upgrade("Synergy 4", new Decimal(1250000), "Divider 4 effect +0.04 per Divider 5 purchased", unlocked=false);