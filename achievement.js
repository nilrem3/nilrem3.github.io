...
var achievementshandler = {
	...
	*/
	...
	new achievement("Perfect Sacrifice", "Sacrifice with 24 of each producer", "+10 base NP when sacrificing", 2),
	...
	new achievement("Overloaded", "Have 6 of each multiplier and 24 of each producer 1-5", "UNLOCK A NEW FEATURE (technically not implemented yet), and also x1.05 all number", 3),//this one doesn't have an unlock yet but the reward is in
